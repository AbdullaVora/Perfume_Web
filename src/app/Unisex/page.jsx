...
const Unisex = () => {
    // Constants
    const BASE_CATEGORY = "Unisex"; // The base category for this page
    ...
    const [selectedCategories, setSelectedCategories] = useState([BASE_CATEGORY]); // Initialize with Unisex category
    ...
    useEffect(() => {
        ...
        const fetchInitialData = async () => {
            try {
                ...
                // Ensure Unisex category is selected
    ...
    useEffect(() => {
        ...
        // First filter active products AND Unisex category products
                    ...
                    <div className={`col-lg-3 mb-4 ${showFilters ? 'd-block' : 'd-none d-lg-block'}`}>
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                ...
                                {/* Subcategories Filter - only show Unisex subcategories */}
                                <div className="mb-4">
                                    <h6 className="d-flex justify-content-between align-items-center">
                                        <span>Categories</span>
                                        <span onClick={() => toggleDropdown('subcategories')}>
